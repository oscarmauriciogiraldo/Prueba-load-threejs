...
function init(){
    ...
    // otra forma 
    texture = new THREE.TextureLoader(loadingManager).load("../crate0/crate0_diffuse.png");
    crateBumpMap = new THREE.TextureLoader(loadingManager).load("../crate0/crate0_bump.png");
    crateNormalMap = new THREE.TextureLoader(loadingManager).load("../crate0/crate0_normal.png");
